...
# Read csv file
dataFrame = pd.read_csv("property_file.csv", index_col=0)

dataFrame = dataFrame.reset_index()

def generate_reports():
    try:
        # Average Price and Square Footage in location
        ...
        avg_location_df = np.round(avg_location_df,2) # round the value using Numpy
        ...
        avg_location_heading = 'Average Price and Square Footage in location'
        ...
        avg_proerty_df = np.round(avg_proerty_df,2) # round the value using Numpy
        ...
        avg_proerty_heading = 'Average Price and Square Footage in proerty'
        ...
        summary_df = np.round(summary_df,2) # round the value using Numpy
